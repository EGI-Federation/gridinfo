...
urlpatterns = patterns('rrd.views',
    ...
    # vo-level
    (r'^VO/(?P<vo>[^/]*)/(?P<attribute>[\w-]+)/(?P<start_time>[\w-]+)/$', 'vo_level'),
    (r'^VO/(?P<vo>[^/]*)/(?P<attribute>[\w-]+)/(?P<start_time>[\w-]+)/(?P<small>small)/$', 'vo_level'),
    # vo-site-level
    (r'^VOSite/(?P<site_name>[^/]*)/(?P<vo>[^/]*)/(?P<attribute>[\w-]+)/(?P<start_time>[\w-]+)/$', 'vo_site_level'),
    (r'^VOSite/(?P<site_name>[^/]*)/(?P<vo>[^/]*)/(?P<attribute>[\w-]+)/(?P<start_time>[\w-]+)/(?P<small>small)/$', 'vo_site_level'),
    # vo-cluster-level                       
