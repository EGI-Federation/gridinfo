schema = {
    ...
    'GLUE2Entity' : {
        ...
        'GLUE2EntityOtherInfo' : ('EntityOtherInfo_t', True, 'Optional'),
        },
    'GLUE2Group' : {
    ...
    'GLUE2Policy' : {
        ...
        'GLUE2PolicyUserDomainForeignKey' : ('URI', False, 'Optional'),
    ...
    'GLUE2ComputingActivity' : {
        'GLUE2ComputingActivityType' : ('ComputingActivityType_t', True, 'Optional'),
        'GLUE2ComputingActivityIDFromEndpoint' : ('URI', True, 'Optional'),
        'GLUE2ComputingActivityLocalIDFromManager' : ('String', True, 'Optional'),
        'GLUE2ComputingActivityJobDescription' : ('JobDescription_t', True, 'Optional'),
        'GLUE2ComputingActivityState' : ('ComputingActivityState_t', False, 'Optional'),
        'GLUE2ComputingActivityRestartState' : ('ComputingActivityState_t', False, 'Optional'),
        'GLUE2ComputingActivityExitCode' : ('Int32', True, 'Optional'),
        'GLUE2ComputingActivityComputingManagerExitCode' : ('String', True, 'Optional'),
        'GLUE2ComputingActivityError' : ('String', False, 'Optional'),
        'GLUE2ComputingActivityWaitingPosition' : ('UInt32', True, 'Optional'),
        'GLUE2ComputingActivityUserDomain' : ('String', True, 'Optional'),
        'GLUE2ComputingActivityOwner' : ('String', True, 'Optional'),
        'GLUE2ComputingActivityLocalOwner' : ('String', True, 'Optional'),
        'GLUE2ComputingActivityRequestedTotalWallTime' : ('UInt64', True, 'Optional'),
        'GLUE2ComputingActivityRequestedTotalCPUTime' : ('UInt64', True, 'Optional'),
        'GLUE2ComputingActivityRequestedSlots' : ('UInt32', True, 'Optional'),
        'GLUE2ComputingActivityRequestedApplicationEnvironment' : ('String', False, 'Optional'),
        'GLUE2ComputingActivityStdIn' : ('String', True, 'Optional'),
        'GLUE2ComputingActivityStdOut' : ('String', True, 'Optional'),
        'GLUE2ComputingActivityStdErr' : ('String', True, 'Optional'),
        'GLUE2ComputingActivityLogDir' : ('String', True, 'Optional'),
        'GLUE2ComputingActivityExecutionNode' : ('String', False, 'Optional'),
        'GLUE2ComputingActivityQueue' : ('String', True, 'Optional'),
        'GLUE2ComputingActivityUsedTotalWallTime' : ('UInt64', True, 'Optional'),
        'GLUE2ComputingActivityUsedTotalCPUTime' : ('UInt64', True, 'Optional'),
        'GLUE2ComputingActivityUsedMainMemory' : ('UInt64', True, 'Optional'),
        'GLUE2ComputingActivitySubmissionTime' : ('DateTime_t', True, 'Optional'),
        'GLUE2ComputingActivityComputingManagerSubmissionTime' : ('DateTime_t', True, 'Optional'),
        'GLUE2ComputingActivityStartTime' : ('DateTime_t', True, 'Optional'),
        'GLUE2ComputingActivityComputingManagerEndTime' : ('DateTime_t', True, 'Optional'),
        'GLUE2ComputingActivityEndTime' : ('DateTime_t', True, 'Optional'),
        'GLUE2ComputingActivityWorkingAreaEraseTime' : ('DateTime_t', True, 'Optional'),
        'GLUE2ComputingActivityProxyExpirationTime' : ('DateTime_t', True, 'Optional'),
        'GLUE2ComputingActivitySubmissionHost' : ('String', True, 'Optional'),
        'GLUE2ComputingActivitySubmissionClientName' : ('String', True, 'Optional'),
        'GLUE2ComputingActivityOtherMessages' : ('String', False, 'Optional'),
        'GLUE2ComputingActivityComputingEndpointForeignKey' : ('URI', True, 'Optional'),
        'GLUE2ComputingActivityComputingShareForeignKey' : ('URI', True, 'Optional'),
        'GLUE2ComputingActivityExecutionEnvironmentForeignKey' : ('URI', True, 'Optional'),
        },
